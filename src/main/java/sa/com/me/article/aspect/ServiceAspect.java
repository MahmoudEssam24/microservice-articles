package sa.com.me.article.aspect;
...
public class ServiceAspect {
    ...
    @AfterReturning(value = "execution(* sa.com.me.article.service..*(..))", returning = "result")
    ...
    @Before("execution(* sa.com.me.article.controller..*(..))")
    ...
    @Before("execution(* sa.com.me.article.service..*(..))")
